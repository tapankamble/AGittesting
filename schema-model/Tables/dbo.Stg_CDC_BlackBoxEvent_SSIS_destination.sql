CREATE TABLE [dbo].[Stg_CDC_BlackBoxEvent_SSIS_destination]
(
...
GO
ALTER TABLE [dbo].[Stg_CDC_BlackBoxEvent_SSIS_destination] ADD CONSTRAINT [Final_ID2_CDC_pk] PRIMARY KEY CLUSTERED ([Final_ID1])
GO
