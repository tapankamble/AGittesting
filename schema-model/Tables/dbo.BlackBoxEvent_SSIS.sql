CREATE TABLE [dbo].[BlackBoxEvent_SSIS]
(
...
GO
ALTER TABLE [dbo].[BlackBoxEvent_SSIS] ADD CONSTRAINT [Final_ID1_pk] PRIMARY KEY CLUSTERED ([Final_ID1])
GO
CREATE UNIQUE NONCLUSTERED INDEX [IND_InstNo_UniqTime1] ON [dbo].[BlackBoxEvent_SSIS] ([AssetId], [EventTime], [InstanceNumber])
GO
CREATE UNIQUE NONCLUSTERED INDEX [IND_InstNo_UniqTime] ON [dbo].[BlackBoxEvent_SSIS] ([InstanceNumber], [EventTime])
GO
